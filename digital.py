...
lbl_month=Label(root,text="Month",font=("times new roman",20,"bold"),bg="#008EA4",fg="white")
...
lbl_noon2=Label(root,text="Parts of Days",font=("times new roman",20,"bold"),bg="#DF002A",fg="white")
